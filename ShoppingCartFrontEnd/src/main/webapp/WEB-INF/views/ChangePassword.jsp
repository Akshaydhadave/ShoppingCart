<div class="panel panel-default">
					  <div class="panel-heading">
                        ...
                        <div class="form-group col-md-12">
                            <form:label path="Cpw">Currnent password: </form:label>
                            <form:input type="password" class="form-control" path="Cpw" placeholder="current password" />
                            
                        </div>

						<div class="form-group col-md-12">
                            <form:label path="NPw1">New Password: </form:label>
                            <form:input type="password" class="form-control" path="NPw1" placeholder="Enter new password" />
                            
                        </div>
						
						 <div class="form-group col-md-12">
                            <form:label path="Npw2">Re-Enter Password: </form:label>
                            <form:input type="password" class="form-control" path="Npw2" placeholder="reenter password" />
