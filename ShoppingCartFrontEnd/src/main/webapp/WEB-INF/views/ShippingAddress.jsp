						  	...
						  	<div class="panel-heading">
								...
								<div class="panel-body">
									<div class="col-md-8 col-md-offset-2">
										<form:form method="post" action="${contextRoot}/addNewAddress" commandName="address">
											<fieldset>
										  ...
										  <div class="col-sm-6 col-md-4">
										    <div class="thumbnail">
											        ...
											        <p>${addresses.pincode}</p>
														...
														<label>
		                                                   <a href="${contextRoot}/updateAddress/${addresses.addid}" class="btn btn-primary " role="button">Edit</a>
		                                                   <a href="${contextRoot}/deleteAddresses/${addresses.addid}" class="btn btn-danger " role="button">Remove</a>
														</label>
